...
const fun = (param1,param2) => {console.log(`The first parameter is ${param1}. The second is ${param2}`)} 

// INVOKE THE FUNCTION HERE. THE PARAMETERS TAKE ANY DATATYPE.
fun('Nathan','impossibly cool')
...
// CODE HERE
function pricePlusTax(pricesArray,callback){
...
// CODE HERE
const newest = (prices,(totalCost)=>{console.log(`The new array plus tax =`, totalCost)})

newest(prices,pricePlusTax)
...
// CODE HERE
const multiplyingFactory = num1 => num2 => {if (num1>=5){console.log(num1*num2)} else console.log('Cannot multiply, the first number is smaller than 5') }
